...
The last goal that project is oriented to, is to learn how to connect multiple subnetworks together using the router interfaces and the routing table, handling subnet ranges overlaps, and assuring the packets are sent to their exact destinations.
